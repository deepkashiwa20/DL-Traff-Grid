...
def train_model(X_train, Y_train):
    ...
    model = DeepSTN(H=HEIGHT, W=WIDTH, channel=CHANNEL,
                    ...
                    is_pt=is_pt, T=INTERVAL, drop=drop)
...
def test_model(X_test, Y_test):
    ...
    pred = model.predict(X_test, verbose=1, batch_size=BATCHSIZE) * MAX_DENSITY
    groundtruth = Y_test * MAX_DENSITY
...
KEYWORD = 'preddensity_DeepSTN+_1907292220'
# KEYWORD = 'preddensity_DeepSTN+_1908221202'
# KEYWORD = 'preddensity_DeepSTN+_1908221705'
PATH = '../' + KEYWORD
###########################Reproducible#############################
import numpy as np
import random
...
if __name__ == '__main__':
    ...
    shutil.copy2('Param_DSTN.py', PATH)
