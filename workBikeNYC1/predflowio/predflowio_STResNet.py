...
def getXSYS(allData, mode, dayInfo=False):
    ...
    startIndex, endIndex = 0, int(len(dates) * trainRatio)
    ...
    # day_info
    if dayInfo:
        day_info = np.genfromtxt(dataPath + '/day_information_onehot.csv', delimiter = ',', skip_header = 1)
