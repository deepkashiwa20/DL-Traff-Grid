...
def model_pred(model_name, test, testTemporal, topo_data):
    ...
    np.save(PATH + '/' + MODELNAME + '_prediction.npy', scaled_predTestY)
    np.save(PATH + '/' + MODELNAME + '_groundtruth.npy', scaled_testY)
...
if __name__ == '__main__':
    ...
    model_train(model_name, train_data, valid_data, trainTemporal, validTemporal, topo_data)
